...
public class SystemOptisActivity extends FragmentActivity implements
	...
	private void getCleanSdCarFragment() {
		...
		iv_system_optis_cache
				.setBackgroundResource(R.drawable.clean_cache_icon);
		tv_system_optis_cache.setTextColor(0xbb000000);
		ll_system_optis_sdcar
				.setBackgroundResource(R.drawable.dg_cancel_selector);
		iv_system_optis_sdcar
				.setBackgroundResource(R.drawable.clean_sdcard_icon_pressed);
		tv_system_optis_sdcar.setTextColor(0xFF7bB226);

		// 填充Fragment
		FragmentTransaction ft_sdcar = getSupportFragmentManager()
				.beginTransaction();
	...
	private void getCleanCacheFragment() {
		...
		ll_system_optis_cache
				.setBackgroundResource(R.drawable.dg_cancel_selector);
		iv_system_optis_cache
				.setBackgroundResource(R.drawable.clean_cache_icon_pressed);
		tv_system_optis_cache.setTextColor(0xFF7bB226);
		ll_system_optis_sdcar.setBackgroundResource(0);
		iv_system_optis_sdcar
				.setBackgroundResource(R.drawable.clean_sdcard_icon);
